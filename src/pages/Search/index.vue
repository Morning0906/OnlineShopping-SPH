            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                ...
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>销量<span v-show="isTwo" class="iconfont "
                  :class="{'icon-xiangshang':isAsc,'icon-paixu':isDesc}"></span></a>
                </li>
                <li>
                  <a href="#">新品</a>
...
export default {
  ...
  //组件挂载完毕执行一次【仅执行一次】
  mounted() {
    //在发请求之前带给服务器参数【searchparams的参数发生变化，有数值带给服务器】
    this.getData();
  },
  computed: {
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      //如果把相应字段变为undefined，当前这个字段不会给服务器
      ...
      //本意是删除query，如果路径当中出现params不该删除，路由跳转的时候应该带着
  ...
  watch: {
    ...
    $route(newValue, oldValue) {
      ...
      Object.assign(this.searchParams, this.$route.query, this.$route.params);
      this.getData();
      //每一次请求完毕应该把123级分类的id置空，使其接受下一次的id
      //分类名字与关键字不用清理，因为每次路由发生变化的时候，都会给他赋予新数值
      this.searchParams.category1Id = undefined;
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
    },
